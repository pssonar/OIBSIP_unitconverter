...
public class tempAcitvity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_temp_acitvity);
        ...
        convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (con.isEmpty()) {
                    Toast.makeText(tempAcitvity.this, "Fill the Unit", Toast.LENGTH_SHORT).show();
                } else {
