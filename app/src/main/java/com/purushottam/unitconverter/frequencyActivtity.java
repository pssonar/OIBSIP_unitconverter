...
public class frequencyActivtity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frequency_activtity);
        ...
        convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (con.isEmpty()) {
                    Toast.makeText(frequencyActivtity.this, "Fill the Unit", Toast.LENGTH_SHORT).show();
                } else {
                    if (hztokz.isChecked()) {
